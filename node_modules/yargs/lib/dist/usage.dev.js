...
module.exports = function (yargs) {
  ...
  self.help = function () {
    ...
    var help = keys.length ? ['Options:'] : []; // your application's commands, i.e., non-option
    ...
    if (keys.length) help.push(''); // describe some common use-cases for your application.
  ...
  function formatTable(table, padding) {
    var output = []; // size of left-hand-column.

    var llen = longest(Object.keys(table)); // don't allow the left-column to take up
    ...
    Object.keys(table).forEach(function (left) {
      ...
      if (leftLines) {
        // handle word-wrapping the left-hand-column.
  ...
  function strcpy(source, destination, width) {
    ...
    for (var i = 0; i < destination.length; i++) {
      var _char = destination.charAt(i);

      if (_char === ' ') _char = source.charAt(i) || _char;
      str += _char;
    }
