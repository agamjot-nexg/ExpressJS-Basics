...
!function e(t, n, r) {
  ...
  1: [function (e) {
    var t = e("../lib/swig");
    "function" == typeof window.define && "object" == _typeof(window.define.amd) ? window.define("swig", [], function () {
      return t;
    }) : window.swig = t;
  }, {
    "../lib/swig": 9
  ...
  2: [function (e, t, n) {
    ...
    n.tzOffset = 0, n.DateZ = function () {
      ...
      setTimezoneOffset: function setTimezoneOffset(e) {
  ...
  3: [function (e, t, n) {
    function r(e) {
      ...
      }) : "object" == _typeof(e) ? (o.each(e, function (e, r) {
    ...
    n.addslashes = function (e) {
      ...
      if ("object" == _typeof(e) && !o.isArray(e)) {
        var t = o.keys(e);
        return e[t[0]];
      }
      ...
      var n;
      if (o.isArray(e)) n = e.sort();else switch (_typeof(e)) {
        case "object":
          n = o.keys(e).sort();
          break;
  ...
  5: [function (e, t) {
    ...
    t.exports = function (e, t) {
      ...
      return t = t || "utf8", e = e ? o.normalize(e) : null, i.resolve = function (t, r) {
        ...
        if (!r || n && !r.readFile || !r.readFileSync) throw new Error("Unable to find file " + e + " because there is no filesystem to read from.");
  ...
  8: [function (e, t, n) {
    ...
    function o(e, t, n, r, o) {
      this.out = [], this.state = [], this.filterApplyIdx = [], this._parsers = {}, this.line = r, this.filename = o, this.filters = t, this.escape = n, this.parse = function () {
        ...
        return t._parsers.start && t._parsers.start.call(t), i.each(e, function (n, r) {
          var o = e[r - 1];
          if (t.isLast = r === e.length - 1, o) for (; o.type === s.WHITESPACE;) {
            r -= 1, o = e[r - 1];
          }
    ...
    o.prototype = {
      ...
      parseToken: function parseToken(e) {
        var t,
            n = this,
        ...
        if (!r || "function" != typeof r || r.call(this, e)) switch (c && a && c === s.FILTER && u === s.FILTER && e.type !== s.PARENCLOSE && e.type !== s.COMMA && e.type !== s.OPERATOR && e.type !== s.FILTER && e.type !== s.FILTEREMPTY && n.out.push(", "), c && c === s.METHODOPEN && (n.state.pop(), e.type !== s.PARENCLOSE && n.out.push(", ")), e.type) {
          case s.WHITESPACE:
            break;
      ...
      parseVar: function parseVar(e, t, n) {
        var r = this;
      ...
      function p(e, t) {
        var n,
            r,
            s = a.read(i.strip(e));
        return n = new o(s, l, d, t, u.filename), r = n.parse().join(""), n.state.length && i.throwError('Unable to parse "' + e + '"', t, u.filename), {
    ...
    n.setDefaults = function (e) {
      ...
      function g(e, t) {
        for (var n, r, o, a = e.parent, s = [], u = []; a;) {
          ...
          if (n = n || t.filename, n = d.options.loader.resolve(a, n), r = c(n, t) || d.parseFile(n, i.extend({}, t, {
            filename: n
      ...
      this.invalidateCache = function () {
        ...
        var n;
        return t || (t = {}), e = d.options.loader.resolve(e, t.resolveFrom), n = d.options.loader.load(e), t.filename || (t = i.extend({
          filename: e
        }, t)), d.parse(n, t);
        ...
        var r, o;
        return t || (t = {}), e = d.options.loader.resolve(e, t.resolveFrom), t.filename || (t = i.extend({
          filename: e
        }, t)), (o = c(e, t)) ? n ? void n(null, o) : o : n ? void d.options.loader.load(e, function (e, r) {
          if (e) return void n(e);
          var o;
  ...
  18: [function (e, t, n) {
    ...
    n.compile = function (e, t) {
      ...
      return o.on(i.STRING, function (e) {
        var t = this;
        if (!c) return c = u.parseFile(e.match.replace(/^("|')|("|')$/g, ""), f).tokens, void r.each(c, function (e) {
          var n,
              r = "";
        ...
        var t = this;
        if (!c || l) throw new Error('Unexpected variable "' + e.match + '" on line ' + n + ".");
        if ("as" !== e.match) return l = e.match, t.out.push(l), !1;
      }), !0;
    }, n.block = !0;
  }, {
    "../parser": 8,
  ...
  26: [function (e, t, n) {
    ...
    n.strip = function (e) {
      ...
      var n, o;
      if (r(e)) for (n = 0, o = e.length, n; o > n && t(e[n], n, e) !== !1; n += 1) {
        ;
      } else for (n in e) {
      ...
      return e ? "object" == _typeof(e) && -1 !== Object.prototype.toString.call(e).indexOf() : !1;
    }, n.some = function (e, t) {
      var o,
          i,
          a = 0;
      if (r(e)) for (i = e.length, a; i > a && !(o = t(e[a], a, e)); a += 1) {
        ;
      ...
      var n,
          o = 0,
          i = [];
      if (r(e)) for (n = e.length, o; n > o; o += 1) {
        i[o] = t(e[o], o);
      } else for (o in e) {
  ...
  27: [function (e, t, n) {
    ...
    function o(e, t) {
      ...
      if (null === e) n = {
        ...
        if ("object" != _typeof(e)) throw new TypeError("typeof prototype[" + _typeof(e) + "] != 'object'");
    ...
    function i(e) {
      return "object" != _typeof(e) && "function" != typeof e || null === e;
    }
  ...
  30: [function (e, t, n) {
    ...
    function s(e, t, r) {
      ...
      if (E(t) && (y = " " + RegExp.prototype.toString.call(t)), b(t) && (y = " " + Date.prototype.toUTCString.call(t)), A(t) && (y = " " + c(t)), 0 === g.length && (!w || 0 == t.length)) return O[0] + y + O[1];
    ...
    function p(e, t, n, r, o, i) {
      ...
      if (c = S.getOwnPropertyDescriptor(t, o) || {
        value: t[o]
      }, c.get ? u = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (u = e.stylize("[Setter]", "special")), k(r, o) || (a = "[" + o + "]"), u || (S.indexOf(e.seen, c.value) < 0 ? (u = d(n) ? s(e, c.value, null) : s(e, c.value, n - 1), u.indexOf("\n") > -1 && (u = i ? u.split("\n").map(function (e) {
        return "  " + e;
      }).join("\n").substr(2) : "\n" + u.split("\n").map(function (e) {
        return "   " + e;
    ...
    function N(e) {
      return e && "object" == _typeof(e) && "function" == typeof e.copy && "function" == typeof e.fill && "function" == typeof e.binarySlice;
    }
    ...
    n.log = function () {
      ...
      for (var n = S.keys(t), r = n.length; r--;) {
        e[n[r]] = t[n[r]];
      }
