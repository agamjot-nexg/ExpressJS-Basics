...
exports.razor = function (path, options, cb) {
  return promisify(cb, function (cb) {
    ...
    try {
      var tmpl = cache(options) || cache(options, function (locals) {
...
exports.twing.render = function (str, options, cb) {
  return promisify(cb, function (cb) {
    ...
    try {
      new engine.TwingEnvironment(new engine.TwingLoaderNull()).createTemplate(str).then(function (twingTemplate) {
        twingTemplate.render(options).then(function (rendTmpl) {
