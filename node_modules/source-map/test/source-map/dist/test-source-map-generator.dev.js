...
define(function (require, exports, module) {
  ...
  exports['test applySourceMap'] = function (assert, util) {
    ...
    expectedMap = expectedMap.toJSON(); // apply source map "mapStep1" to "mapStep2"
  ...
  exports['test the two additional parameters of applySourceMap'] = function (assert, util) {
    ...
    var actualMap = function actualMap(aSourceMapPath) {
      var map = SourceMapGenerator.fromSourceMap(minifiedMap); // Note that relying on `bundleMap.file` (which is simply 'bundle.js')
  ...
  exports['test ignore duplicate mappings.'] = function (assert, util) {
    ...
    var map1, map2; // null original source location
    ...
    util.assertEqualMaps(assert, map1.toJSON(), map2.toJSON()); // original source location
    ...
    util.assertEqualMaps(assert, map1.toJSON(), map2.toJSON()); // full original source and name information
