...
define(function (require, exports, module) {
  ...
  exports['test eating our own dog food'] = function (assert, util) {
    ...
    var smc = new SourceMapConsumer(smg.toString()); // Exact
    ...
    util.assertMapping(6, 12, '/wu/tang/gza.coffee', 5, 10, null, smc, assert); // Fuzzy
    ...
    util.assertMapping(6, 13, '/wu/tang/gza.coffee', 5, 10, null, smc, assert, true); // Original to generated
