...
define(function (require, exports, module) {
  ...
  exports['test mapping tokens fuzzy'] = function (assert, util) {
    var map = new SourceMapConsumer(util.testMap); // Finding original positions
    ...
    util.assertMapping(2, 12, '/the/root/two.js', 1, 11, null, map, assert, true); // Finding generated positions
  ...
  exports['test mappings and end of lines'] = function (assert, util) {
    ...
    var map = SourceMapConsumer.fromSourceMap(smg); // When finding original positions, mappings end at the end of the line.
  ...
  exports['test sourceRoot + generatedPositionFor'] = function (assert, util) {
    ...
    map = new SourceMapConsumer(map.toString()); // Should handle without sourceRoot.
    ...
    assert.equal(pos.column, 2); // Should handle with sourceRoot.
